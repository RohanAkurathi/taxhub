    ...
    items: [
      {
        ...
        authorRole: "preparer",
        visibility: "client",
        body: "Hi Marcus — your W-2 came through clean and it's already on the return. One more form and we're set.",
      ...
      },
      {
        ...
        authorRole: "preparer",
        visibility: "internal",
        body: "Prior year had $1,395 interest from Chase — if he says he has no 1099-INT, push back gently.",
    ...
    items: [
      {
        ...
        authorRole: "reviewer",
        visibility: "internal",
        body: "@Jordan flagging line 13 — confirm the consulting isn't an SSTB before the QBI deduction stands.",
        at: "2026-03-21T16:05:00",
      ...
      },
      {
        ...
        authorRole: "preparer",
        visibility: "internal",
        body: "Pulling his engagement list to check the client mix. Will confirm today.",
